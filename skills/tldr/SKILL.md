---
name: tldr
description: TLDR code analysis — call graphs, semantic search, impact, dataflow; ~95% token savings vs raw reads. Auto-invoke for "who calls X", "what affects X", before large file reads or refactors.
context: fork
