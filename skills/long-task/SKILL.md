---
name: long-task
description: Long-running autonomous task — phased execution with checkpoints and recovery across interruptions. Triggers "overnight", "long running", "autonomous task", "extended task", "marathon", "multi-hour task".
context: fork
---
