...
cc-settings ships three plugins through this surface, all declared in `.claude-plugin/marketplace.json` and enabled via `config/10-core.json`'s `enabledPlugins`:
