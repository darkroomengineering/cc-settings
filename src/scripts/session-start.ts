...
// Remove retired per-session counters and markers left by older installs.
// Keep the seven-day sweep so upgrades do not strand existing files.
...
await Promise.all([
  // Older skills also wrote this marker without a session suffix.
